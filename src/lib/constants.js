...
export const PHASE_ORDER = ['descubrimiento', 'diseno', 'desarrollo', 'revision', 'entrega']
export const PHASE_PROGRESS = { descubrimiento: 20, diseno: 40, desarrollo: 60, revision: 80, entrega: 100 }
