    ...
    <div className="min-h-screen relative">
      ...
      <main className="md:ml-[248px] px-4 md:px-8 pt-5 md:pt-6 pb-10 max-w-[1260px] relative z-10">
        <div className="flex items-center gap-3.5 mb-7">
          <button className="md:hidden p-2 text-white/55" onClick={() => setOpen(o => !o)}>
          ...
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}>
            <h1 className="text-[22px] font-extrabold tracking-tight">Hola, {firstName} <span className="inline-block animate-[float_2.5s_ease-in-out_infinite]">👋</span></h1>
